<div class="ds-content">
    ...
    <div class="ds-catalog-grid">
        ...
        <div class="ds-catalog-card">
            ...
            <div class="ds-catalog-overlay">
                <div class="ds-catalog-top">
                    <span class="ds-cat-label">PERIOD ARCHIVE - 1880S</span>
                </div>
                <div class="ds-catalog-bottom">
                    <h3 class="ds-cat-title">Crimson<br>Sovereign</h3>
                    <div class="ds-cat-price">
                        <strong>$1,200</strong><span>/day</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ds-catalog-card">
            ...
            <div class="ds-catalog-overlay">
                <div class="ds-catalog-top">
                    <span class="ds-cat-label">ARCHITECTURAL - SUMMER</span>
                </div>
                <div class="ds-catalog-bottom">
                    <h3 class="ds-cat-title">Alabaster<br>Fold</h3>
                    <div class="ds-cat-price">
                        <strong>$600</strong><span>/day</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Item 4 -->
        <div class="ds-catalog-card">
            <img src="assets/catalog_4.png" alt="Aurum Weaver">
            <div class="ds-catalog-overlay">
                <div class="ds-catalog-top">
                    <span class="ds-cat-label">GALA COUTURE</span>
                </div>
                <div class="ds-catalog-bottom">
                    <h3 class="ds-cat-title">Aurum<br>Weaver</h3>
                    <div class="ds-cat-price">
                        <strong>$2,450</strong><span>/day</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ds-catalog-card">
            ...
            <div class="ds-catalog-overlay">
                <div class="ds-catalog-top">
                    <span class="ds-cat-label">MODERNIST COUTURE</span>
                </div>
                <div class="ds-catalog-bottom">
                    <h3 class="ds-cat-title">Canary<br>Volume</h3>
                    <div class="ds-cat-price">
                        <strong>$920</strong><span>/day</span>
                    </div>
                </div>
            </div>
        </div>
